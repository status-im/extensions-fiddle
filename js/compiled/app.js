var CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=cd69d6&fwbuild=dev"};
...
document.write('<script>goog.require("pluto.playground.figwheel");</script>');
