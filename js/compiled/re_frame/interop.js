...
return [(function (){var pred__4086 = cljs.core.instance_QMARK_;
var expr__4087 = reactive_val;
if(cljs.core.truth_((pred__4086.cljs$core$IFn$_invoke$arity$2 ? pred__4086.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__4087) : pred__4086.call(null,reagent.ratom.RAtom,expr__4087)))){
return "ra";
} else {
if(cljs.core.truth_((pred__4086.cljs$core$IFn$_invoke$arity$2 ? pred__4086.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__4087) : pred__4086.call(null,reagent.ratom.RCursor,expr__4087)))){
return "rc";
} else {
if(cljs.core.truth_((pred__4086.cljs$core$IFn$_invoke$arity$2 ? pred__4086.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__4087) : pred__4086.call(null,reagent.ratom.Reaction,expr__4087)))){
return "rx";
} else {
if(cljs.core.truth_((pred__4086.cljs$core$IFn$_invoke$arity$2 ? pred__4086.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__4087) : pred__4086.call(null,reagent.ratom.Track,expr__4087)))){
return "tr";
} else {
return "other";
}
