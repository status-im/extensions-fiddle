...
var G__3905 = o;
(G__3905[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__3906__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__3906 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__3907__i = 0, G__3907__a = new Array(arguments.length -  0);
while (G__3907__i < G__3907__a.length) {G__3907__a[G__3907__i] = arguments[G__3907__i + 0]; ++G__3907__i;}
  args = new cljs.core.IndexedSeq(G__3907__a,0,null);
} 
return G__3906__delegate.call(this,args);};
G__3906.cljs$lang$maxFixedArity = 0;
G__3906.cljs$lang$applyTo = (function (arglist__3908){
var args = cljs.core.seq(arglist__3908);
return G__3906__delegate(args);
});
...
var G__3909 = o;
(G__3909[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__3911__i = 0, G__3911__a = new Array(arguments.length -  0);
while (G__3911__i < G__3911__a.length) {G__3911__a[G__3911__i] = arguments[G__3911__i + 0]; ++G__3911__i;}
  args = new cljs.core.IndexedSeq(G__3911__a,0,null);
} 
return G__3910__delegate.call(this,args);};
G__3910.cljs$lang$maxFixedArity = 0;
G__3910.cljs$lang$applyTo = (function (arglist__3912){
var args = cljs.core.seq(arglist__3912);
return G__3910__delegate(args);
});
...
var G__3914 = props;
var G__3914__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__3914,cljs.core.cst$kw$id,id):G__3914);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__3914__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__3915){
var map__3916 = p__3915;
var map__3916__$1 = (((((!((map__3916 == null))))?(((((map__3916.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3916.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__3916):map__3916);
var props = map__3916__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__3916__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__3916,map__3916__$1,props,class$){
return (function (c){
...
});})(map__3916,map__3916__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__3918){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__3919__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__3919,map__3919__$1,on_write){
return (function (){
...
});})(node_value,map__3919,map__3919__$1,on_write))
);
} else {
...
var G__3922 = jsprops;
(G__3922["defaultValue"] = value);

(G__3922["onChange"] = ((function (G__3922,v,value,on_change){
return (function (p1__3921_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__3921_SHARP_);
});})(G__3922,v,value,on_change))
);
...
var vec__3925 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3925,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3925,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3925,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___3929 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___3929 == null)){
} else {
var key_3930 = temp__5724__auto___3929;
(jsprops["key"] = key_3930);
}
...
var temp__5724__auto___3931 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___3931 == null)){
} else {
var key_3932 = temp__5724__auto___3931;
reagent.impl.template.oset(jsprops,"key",key_3932);
}
...
var G__3933 = reagent.impl.template.__GT_NativeWrapper();
(G__3933["name"] = c);
...
var G__3934 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__3934) : reagent.impl.template.as_element.call(null,G__3934));
} else {
...
var len__4730__auto___3940 = arguments.length;
var i__4731__auto___3941 = (0);
while(true){
if((i__4731__auto___3941 < len__4730__auto___3940)){
args__4736__auto__.push((arguments[i__4731__auto___3941]));

var G__3942 = (i__4731__auto___3941 + (1));
i__4731__auto___3941 = G__3942;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq3938){
var G__3939 = cljs.core.first(seq3938);
var seq3938__$1 = cljs.core.next(seq3938);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3939,seq3938__$1);
});
...
break;
default:
var G__3945 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__3945;
continue;
...
var n__4607__auto___3947 = a.length;
var i_3948 = (0);
while(true){
if((i_3948 < n__4607__auto___3947)){
(a[i_3948] = reagent.impl.template.as_element((a[i_3948])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___3950 = a.length;
var i_3951 = (0);
while(true){
if((i_3951 < n__4607__auto___3950)){
var val_3952 = (a[i_3951]);
if(((cljs.core.vector_QMARK_(val_3952)) && ((reagent.impl.template.key_from_vec(val_3952) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_3951] = reagent.impl.template.as_element(val_3952));

var G__3953 = (i_3951 + (1));
i_3951 = G__3953;
continue;
} else {
}
...
var ctx = ({});
var vec__3954 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3954,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3954,(1),null);
...
var G__3957 = (cljs.core.count(argv) - first_child);
switch (G__3957) {
case (0):
...
var G__3958 = comp;
var G__3959 = jsprops;
var G__3960 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__3958,G__3959,G__3960) : reagent.impl.template.global$module$react.createElement.call(null,G__3958,G__3959,G__3960));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__3957){
