...
var G__3903 = o;
(G__3903[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__3905__i = 0, G__3905__a = new Array(arguments.length -  0);
while (G__3905__i < G__3905__a.length) {G__3905__a[G__3905__i] = arguments[G__3905__i + 0]; ++G__3905__i;}
  args = new cljs.core.IndexedSeq(G__3905__a,0,null);
} 
return G__3904__delegate.call(this,args);};
G__3904.cljs$lang$maxFixedArity = 0;
G__3904.cljs$lang$applyTo = (function (arglist__3906){
var args = cljs.core.seq(arglist__3906);
return G__3904__delegate(args);
});
...
var G__3907 = o;
(G__3907[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__3909__i = 0, G__3909__a = new Array(arguments.length -  0);
while (G__3909__i < G__3909__a.length) {G__3909__a[G__3909__i] = arguments[G__3909__i + 0]; ++G__3909__i;}
  args = new cljs.core.IndexedSeq(G__3909__a,0,null);
} 
return G__3908__delegate.call(this,args);};
G__3908.cljs$lang$maxFixedArity = 0;
G__3908.cljs$lang$applyTo = (function (arglist__3910){
var args = cljs.core.seq(arglist__3910);
...
var G__3912 = props;
var G__3912__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__3912,cljs.core.cst$kw$id,id):G__3912);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__3912__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__3913){
var map__3914 = p__3913;
var map__3914__$1 = (((((!((map__3914 == null))))?(((((map__3914.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3914.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__3914):map__3914);
var props = map__3914__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__3914__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__3914,map__3914__$1,props,class$){
return (function (c){
...
});})(map__3914,map__3914__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__3916){
var map__3917 = p__3916;
var map__3917__$1 = (((((!((map__3917 == null))))?(((((map__3917.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3917.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__3917):map__3917);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__3917__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__3917,map__3917__$1,on_write){
return (function (){
...
});})(node_value,map__3917,map__3917__$1,on_write))
);
} else {
...
var G__3920 = jsprops;
(G__3920["defaultValue"] = value);

(G__3920["onChange"] = ((function (G__3920,v,value,on_change){
return (function (p1__3919_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__3919_SHARP_);
});})(G__3920,v,value,on_change))
);
...
var vec__3923 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3923,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3923,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3923,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___3927 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___3927 == null)){
} else {
var key_3928 = temp__5724__auto___3927;
(jsprops["key"] = key_3928);
}
...
var temp__5724__auto___3929 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___3929 == null)){
} else {
var key_3930 = temp__5724__auto___3929;
reagent.impl.template.oset(jsprops,"key",key_3930);
}
...
var G__3931 = reagent.impl.template.__GT_NativeWrapper();
(G__3931["name"] = c);
...
var G__3932 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__3932) : reagent.impl.template.as_element.call(null,G__3932));
} else {
...
var len__4730__auto___3938 = arguments.length;
var i__4731__auto___3939 = (0);
while(true){
if((i__4731__auto___3939 < len__4730__auto___3938)){
args__4736__auto__.push((arguments[i__4731__auto___3939]));

var G__3940 = (i__4731__auto___3939 + (1));
i__4731__auto___3939 = G__3940;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq3936){
var G__3937 = cljs.core.first(seq3936);
var seq3936__$1 = cljs.core.next(seq3936);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3937,seq3936__$1);
});
...
break;
default:
var G__3943 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__3943;
continue;
...
var n__4607__auto___3945 = a.length;
var i_3946 = (0);
while(true){
if((i_3946 < n__4607__auto___3945)){
(a[i_3946] = reagent.impl.template.as_element((a[i_3946])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___3948 = a.length;
var i_3949 = (0);
while(true){
if((i_3949 < n__4607__auto___3948)){
var val_3950 = (a[i_3949]);
if(((cljs.core.vector_QMARK_(val_3950)) && ((reagent.impl.template.key_from_vec(val_3950) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_3949] = reagent.impl.template.as_element(val_3950));

var G__3951 = (i_3949 + (1));
i_3949 = G__3951;
continue;
} else {
}
...
var ctx = ({});
var vec__3952 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3952,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3952,(1),null);
...
var G__3955 = (cljs.core.count(argv) - first_child);
switch (G__3955) {
case (0):
...
var G__3956 = comp;
var G__3957 = jsprops;
var G__3958 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__3956,G__3957,G__3958) : reagent.impl.template.global$module$react.createElement.call(null,G__3956,G__3957,G__3958));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__3955){
