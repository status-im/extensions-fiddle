...
if((i < len)){
var k = (ks[i]);
var G__3835 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__3836 = (i + (1));
m = G__3835;
i = G__3836;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__3837 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__3837) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__3837));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__3839 = c;
var G__3839__$1 = (((G__3839 == null))?null:G__3839.prototype);
if((G__3839__$1 == null)){
return null;
} else {
return (G__3839__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__3841 = c;
var G__3841__$1 = (((G__3841 == null))?null:G__3841.prototype);
if((G__3841__$1 == null)){
return null;
} else {
return (G__3841__$1["render"]);
}
})() == null)))));
});
...
var G__3843 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__3843) : reagent.impl.component.as_element.call(null,G__3843));
};
...
var _STAR_current_component_STAR__orig_val__3849 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__3850 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__3850;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__3849;
}});
...
var G__3851 = key;
var G__3851__$1 = (((G__3851 instanceof cljs.core.Keyword))?G__3851.fqn:null);
switch (G__3851__$1) {
...
return ((function (G__3851,G__3851__$1){
...
var c = this;
var G__3856_3858 = (c["cljsRatom"]);
if((G__3856_3858 == null)){
} else {
reagent.ratom.dispose_BANG_(G__3856_3858);
}
...
var renders_3860 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_3861 = cljs.core.first(cljs.core.vals(renders_3860));
if((cljs.core.count(renders_3860) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_3860))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_3861)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_3861], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__3859 = name;
switch (G__3859) {
case "":
...
var G__3864 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__3864) : reagent.impl.component.global$module$create_react_class.call(null,G__3864));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__3865 = fiber;
var G__3865__$1 = (((G__3865 == null))?null:(G__3865["type"]));
if((G__3865__$1 == null)){
return null;
} else {
return (G__3865__$1["displayName"]);
}
})();
var parent = (function (){var G__3866 = fiber;
if((G__3866 == null)){
return null;
} else {
return (G__3866["return"]);
}
})();
var path = (function (){var G__3867 = parent;
var G__3867__$1 = (((G__3867 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__3867) : reagent.impl.component.fiber_component_path.call(null,G__3867)));
if((G__3867__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3867__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__3869 = c;
if((G__3869 == null)){
return null;
} else {
return (G__3869["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__3870._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__3872 = c;
if((G__3872 == null)){
return null;
} else {
return (G__3872["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__3874 = c;
if((G__3874 == null)){
return null;
} else {
return G__3874._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__3876 = instance;
if((G__3876 == null)){
return null;
} else {
return (G__3876["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__3877 = instance;
if((G__3877 == null)){
return null;
} else {
return G__3877._currentElement;
}
}
})();
var name = (function (){var G__3878 = elem;
var G__3878__$1 = (((G__3878 == null))?null:(G__3878["type"]));
if((G__3878__$1 == null)){
return null;
} else {
return (G__3878__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__3880 = elem;
if((G__3880 == null)){
return null;
} else {
return (G__3880["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__3881._owner;
}
}
})();
var path = (function (){var G__3882 = owner;
var G__3882__$1 = (((G__3882 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__3882) : reagent.impl.component.component_path.call(null,G__3882)));
if((G__3882__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3882__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__3883 = c;
var G__3883__$1 = (((G__3883 == null))?null:G__3883.constructor);
if((G__3883__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__3883__$1);
}
}
})();
