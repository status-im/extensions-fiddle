...
var G__3603 = pluto.storage.http.result(xhr);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__3603) : callback.call(null,G__3603));
} else {
return null;
}
});})(xhr))
...
pluto.storage.http.HTTPStorage.prototype.pluto$storage$Storage$fetch$arity$3 = (function (_,p__3604,callback){
var self__ = this;
var map__3605 = p__3604;
var map__3605__$1 = (((((!((map__3605 == null))))?(((((map__3605.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3605.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__3605):map__3605);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__3605__$1,cljs.core.cst$kw$value);
var ___$1 = this;
