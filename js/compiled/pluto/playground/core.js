...
var G__1985__delegate = function (args){
...
var G__1985 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__1986__i = 0, G__1986__a = new Array(arguments.length -  0);
while (G__1986__i < G__1986__a.length) {G__1986__a[G__1986__i] = arguments[G__1986__i + 0]; ++G__1986__i;}
  args = new cljs.core.IndexedSeq(G__1986__a,0,null);
} 
return G__1985__delegate.call(this,args);};
G__1985.cljs$lang$maxFixedArity = 0;
G__1985.cljs$lang$applyTo = (function (arglist__1987){
var args = cljs.core.seq(arglist__1987);
return G__1985__delegate(args);
});
G__1985.cljs$core$IFn$_invoke$arity$variadic = G__1985__delegate;
return G__1985;
})()
], null));
pluto.playground.core.dispatch_events = (function pluto$playground$core$dispatch_events(ctx,events){
var seq__1988 = cljs.core.seq(events);
var chunk__1989 = null;
var count__1990 = (0);
var i__1991 = (0);
while(true){
if((i__1991 < count__1990)){
var event = chunk__1989.cljs$core$IIndexed$_nth$arity$2(null,i__1991);
...
var G__1992 = seq__1988;
var G__1993 = chunk__1989;
var G__1994 = count__1990;
var G__1995 = (i__1991 + (1));
seq__1988 = G__1992;
chunk__1989 = G__1993;
count__1990 = G__1994;
i__1991 = G__1995;
...
var temp__5457__auto__ = cljs.core.seq(seq__1988);
if(temp__5457__auto__){
var seq__1988__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__1988__$1)){
var c__4550__auto__ = cljs.core.chunk_first(seq__1988__$1);
var G__1996 = cljs.core.chunk_rest(seq__1988__$1);
var G__1997 = c__4550__auto__;
var G__1998 = cljs.core.count(c__4550__auto__);
var G__1999 = (0);
seq__1988 = G__1996;
chunk__1989 = G__1997;
count__1990 = G__1998;
...
var event = cljs.core.first(seq__1988__$1);
if(cljs.core.vector_QMARK_(event)){
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(event) : re_frame.core.dispatch.call(null,event));
} else {
pluto.log.fire_BANG_(ctx,cljs.core.cst$kw$pluto$log_SLASH_error,cljs.core.cst$kw$event_SLASH_dispatch,event);
...
var G__2000 = cljs.core.next(seq__1988__$1);
var G__2001 = null;
var G__2002 = (0);
var G__2003 = (0);
seq__1988 = G__2000;
...
pluto.playground.core.resolve_query = (function pluto$playground$core$resolve_query(ctx,p__2004){
var vec__2005 = p__2004;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2005,(0),null);
var data = vec__2005;
...
pluto.playground.core.cartouche = (function pluto$playground$core$cartouche(p__2008,data){
...
var m = map__2009__$1;
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2009__$1,cljs.core.cst$kw$path);
var p = cljs.core.deref((function (){var G__2011 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$extension_SLASH_selected], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__2011) : re_frame.core.subscribe.call(null,G__2011));
})());
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$on_DASH_mouse_DASH_enter,((function (p,map__2009,map__2009__$1,m,path){
return (function (){
var G__2012 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$extension_SLASH_set_DASH_selected,path], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__2012) : re_frame.core.dispatch.call(null,G__2012));
});})(p,map__2009,map__2009__$1,m,path))
,cljs.core.cst$kw$on_DASH_mouse_DASH_leave,((function (p,map__2009,map__2009__$1,m,path){
return (function (){
var G__2013 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$extension_SLASH_set_DASH_selected,null], null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,cljs.core.reduce_kv((function (p1__2016_SHARP_,p2__2018_SHARP_,p3__2017_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(p1__2016_SHARP_,cljs.core.vals(p3__2017_SHARP_));
...
var logs2022 = (function (){var G__2024 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$extension_SLASH_filtered_DASH_logs], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__2024) : re_frame.core.subscribe.call(null,G__2024));
})();
var errors2023 = (function (){var G__2025 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$extension_SLASH_errors], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__2025) : re_frame.core.subscribe.call(null,G__2025));
})();
return reagent.core.create_class(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$reagent_DASH_render,((function (logs2022,errors2023){
return (function (){
var logs = cljs.core.deref(logs2022);
var errors = cljs.core.deref(errors2023);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$display,cljs.core.cst$kw$flex,cljs.core.cst$kw$height,"100vh"], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.playground.components.publish.publish_dialog], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$flex,(4),cljs.core.cst$kw$display,cljs.core.cst$kw$flex,cljs.core.cst$kw$flex_DASH_direction,cljs.core.cst$kw$column], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$flex,(3),cljs.core.cst$kw$height,"200px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.playground.components.source.editor,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_change,((function (logs,errors,logs2022,errors2023){
return (function (p1__2019_SHARP_){
var G__2026 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$extension_SLASH_update_DASH_source,pluto.playground.core.ctx,p1__2019_SHARP_], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__2026) : re_frame.core.dispatch.call(null,G__2026));
});})(logs,errors,logs2022,errors2023))
], null)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$flex,(1),cljs.core.cst$kw$display,cljs.core.cst$kw$flex,cljs.core.cst$kw$flex_DASH_direction,cljs.core.cst$kw$column,cljs.core.cst$kw$margin_DASH_top,(10)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$flex,(1),cljs.core.cst$kw$display,cljs.core.cst$kw$flex,cljs.core.cst$kw$justify_DASH_content,cljs.core.cst$kw$flex_DASH_end,cljs.core.cst$kw$align_DASH_items,cljs.core.cst$kw$center], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.playground.core.switch$,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$color,"primary",cljs.core.cst$kw$on_DASH_change,((function (logs,errors,logs2022,errors2023){
return (function (p1__2021_SHARP_,p2__2020_SHARP_){
var G__2027 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$extension_SLASH_switch_DASH_filter_DASH_logs,p2__2020_SHARP_], null);
...
return (function (){
var G__2029 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$extension_SLASH_publish], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__2029) : re_frame.core.dispatch.call(null,G__2029));
});})(logs,errors,logs2022,errors2023))
...
var G__2032_2033 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$fetch_DASH_extension], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__2032_2033) : re_frame.core.dispatch.call(null,G__2032_2033));
