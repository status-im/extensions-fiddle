...
var hierarchy__4617__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$hierarchy,(function (){var fexpr__2120 = cljs.core.get_global_hierarchy;
return (fexpr__2120.cljs$core$IFn$_invoke$arity$0 ? fexpr__2120.cljs$core$IFn$_invoke$arity$0() : fexpr__2120.call(null));
})());
...
var G__2121 = cljs.core.name(s);
return (keys.cljs$core$IFn$_invoke$arity$1 ? keys.cljs$core$IFn$_invoke$arity$1(G__2121) : keys.call(null,G__2121));
});
...
pluto.core.parse_value.cljs$core$IMultiFn$_add_method$arity$3(null,"events",(function (p__2122,ext,k,v){
...
var ctx = map__2123__$1;
var capacities = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2123__$1,cljs.core.cst$kw$capacities);
return pluto.core.parse_value_with(capacities,cljs.core.cst$kw$events,k,((function (map__2123,map__2123__$1,ctx,capacities){
return (function (){
return pluto.reader.events.parse(ctx,ext,v,"");
});})(map__2123,map__2123__$1,ctx,capacities))
);
}));
pluto.core.parse_value.cljs$core$IMultiFn$_add_method$arity$3(null,"views",(function (p__2125,ext,k,v){
...
var ctx = map__2126__$1;
var capacities = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2126__$1,cljs.core.cst$kw$capacities);
return pluto.core.parse_value_with(capacities,cljs.core.cst$kw$components,k,((function (map__2126,map__2126__$1,ctx,capacities){
return (function (){
return pluto.reader.views.parse.cljs$core$IFn$_invoke$arity$3(ctx,ext,v);
});})(map__2126,map__2126__$1,ctx,capacities))
);
}));
/**
 * Type of a hook
...
pluto.core.parse_value.cljs$core$IMultiFn$_add_method$arity$3(null,"hooks",(function (p__2128,ext,k,o){
...
var ctx = map__2129__$1;
var capacities = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2129__$1,cljs.core.cst$kw$capacities);
return pluto.core.parse_value_with(capacities,cljs.core.cst$kw$hooks,k,((function (map__2129,map__2129__$1,ctx,capacities){
return (function (){
var map__2131 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ctx,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$capacities,cljs.core.cst$kw$hooks,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(pluto.core.hook_type(k))], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2131__$1,cljs.core.cst$kw$properties);
...
});})(map__2129,map__2129__$1,ctx,capacities))
);
}));
...
var map__2133 = (pluto.core.parse_value.cljs$core$IFn$_invoke$arity$4 ? pluto.core.parse_value.cljs$core$IFn$_invoke$arity$4(ctx,ext,k,v) : pluto.core.parse_value.call(null,ctx,ext,k,v));
...
return cljs.core.reduce_kv((function (p1__2135_SHARP_,p2__2136_SHARP_,p3__2137_SHARP_){
return pluto.core.accumulate(ctx,ext,p1__2135_SHARP_,p2__2136_SHARP_,p3__2137_SHARP_);
