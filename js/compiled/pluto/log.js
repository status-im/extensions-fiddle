 ...
 */
pluto.log.fire_BANG_ = (function pluto$log$fire_BANG_(p__1598,category,type,data){
...
var log_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1599__$1,cljs.core.cst$kw$log_DASH_fn);
if(cljs.core.fn_QMARK_(log_fn)){
var G__1601 = pluto.log.create(category,type,data);
return (log_fn.cljs$core$IFn$_invoke$arity$1 ? log_fn.cljs$core$IFn$_invoke$arity$1(G__1601) : log_fn.call(null,G__1601));
} else {
return null;
}
});
