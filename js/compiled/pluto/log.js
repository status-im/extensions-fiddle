 ...
 */
pluto.log.fire_BANG_ = (function pluto$log$fire_BANG_(p__2628,category,type,data){
var map__2629 = p__2628;
var map__2629__$1 = (((((!((map__2629 == null))))?(((((map__2629.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2629.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__2629):map__2629);
var log_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2629__$1,cljs.core.cst$kw$log_DASH_fn);
if(cljs.core.fn_QMARK_(log_fn)){
var G__2631 = pluto.log.create(category,type,data);
return (log_fn.cljs$core$IFn$_invoke$arity$1 ? log_fn.cljs$core$IFn$_invoke$arity$1(G__2631) : log_fn.call(null,G__2631));
} else {
return null;
}
});
