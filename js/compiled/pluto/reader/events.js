...
var map__1809 = pluto.utils.interpolate(m,v);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1809__$1,cljs.core.cst$kw$data);
...
return (function (p1__1811_SHARP_,p2__1812_SHARP_){
var G__1813 = p1__1811_SHARP_;
var G__1814 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$a,p2__1812_SHARP_], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$env,env], null)], 0));
return (o.cljs$core$IFn$_invoke$arity$2 ? o.cljs$core$IFn$_invoke$arity$2(G__1813,G__1814) : o.call(null,G__1813,G__1814));
});
} else {
...
return cljs.core.reduce_kv((function (p1__1815_SHARP_,p2__1816_SHARP_,p3__1817_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__1815_SHARP_,p2__1816_SHARP_,pluto.reader.events.replace_atom(ctx,env,p3__1817_SHARP_));
 ...
 */
pluto.reader.events.dispatch_events = (function pluto$reader$events$dispatch_events(p__1818,events,raw_QMARK_){
...
var ctx = map__1819__$1;
var event_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1819__$1,cljs.core.cst$kw$event_DASH_fn);
 ...
 */
pluto.reader.events.resolve_event = (function pluto$reader$events$resolve_event(ctx,ext,env,p__1821){
var vec__1822 = p__1821;
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1822,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1822,(1),null);
var reference = vec__1822;
var map__1825 = pluto.reader.reference.resolve(ctx,ext,cljs.core.cst$kw$event,reference);
...
var map__1826 = pluto.reader.events.resolve_arguments(ctx,ext,event,(function (){var or__4131__auto__ = args;
...
var inline = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1826__$1,cljs.core.cst$kw$data);
...
var vec__1829 = ref;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1829,(0),null);
var test = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1829,(1),null);
var if$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1829,(2),null);
var else$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1829,(3),null);
 ...
 */
pluto.reader.events.resolve_query = (function pluto$reader$events$resolve_query(p__1832,ext,query){
var map__1833 = p__1832;
var map__1833__$1 = (((((!((map__1833 == null))))?(((((map__1833.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1833.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1833):map__1833);
var ctx = map__1833__$1;
var query_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1833__$1,cljs.core.cst$kw$query_DASH_fn);
var map__1835 = (function (){var G__1836 = ctx;
var G__1837 = ext;
var G__1838 = cljs.core.cst$kw$query;
var G__1839 = query;
return (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(G__1836,G__1837,G__1838,G__1839) : pluto.reader.types.resolve.call(null,G__1836,G__1837,G__1838,G__1839));
})();
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1835__$1,cljs.core.cst$kw$data);
...
pluto.reader.events.merge_resolved_query = (function pluto$reader$events$merge_resolved_query(ctx,ext,m,p__1841){
var map__1842 = p__1841;
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1842__$1,cljs.core.cst$kw$value);
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1842__$1,cljs.core.cst$kw$bindings);
 ...
 */
pluto.reader.events.event_dispatcher = (function pluto$reader$events$event_dispatcher(ctx,ext,refs,arguments$,p__1847){
var map__1848 = p__1847;
var map__1848__$1 = (((((!((map__1848 == null))))?(((((map__1848.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1848.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1848):map__1848);
var queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1848__$1,cljs.core.cst$kw$queries);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1848__$1,cljs.core.cst$kw$properties);
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,cljs.core.with_meta(((function (map__1848,map__1848__$1,queries,properties){
return (function (dynamic,p__1850){
var map__1851 = p__1850;
...
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1851__$1,cljs.core.cst$kw$env);
var raw_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1851__$1,cljs.core.cst$kw$raw_QMARK_);
var map__1853 = pluto.reader.destructuring.destructure(properties,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([dynamic,arguments$], 0)));
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1853__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1853__$1,cljs.core.cst$kw$errors);
if(cljs.core.seq(errors)){
pluto.log.fire_BANG_(ctx,cljs.core.cst$kw$pluto$log_SLASH_error,cljs.core.cst$kw$event_SLASH_destructuring,errors);
} else {
}

var env_SINGLEQUOTE_ = pluto.reader.events.resolve_env(ctx,env,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([env,cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (map__1853,map__1853__$1,data,errors,map__1851,map__1851__$1,env,raw_QMARK_,map__1848,map__1848__$1,queries,properties){
return (function (p1__1844_SHARP_,p2__1845_SHARP_){
return pluto.reader.events.merge_resolved_query(ctx,ext,p1__1844_SHARP_,p2__1845_SHARP_);
});})(map__1853,map__1853__$1,data,errors,map__1851,map__1851__$1,env,raw_QMARK_,map__1848,map__1848__$1,queries,properties))
,data,queries)], 0)));
return pluto.reader.events.dispatch_events(ctx,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (env_SINGLEQUOTE_,map__1853,map__1853__$1,data,errors,map__1851,map__1851__$1,env,raw_QMARK_,map__1848,map__1848__$1,queries,properties){
return (function (p1__1846_SHARP_){
return pluto.reader.events.create_event(ctx,ext,env_SINGLEQUOTE_,p1__1846_SHARP_);
});})(env_SINGLEQUOTE_,map__1853,map__1853__$1,data,errors,map__1851,map__1851__$1,env,raw_QMARK_,map__1848,map__1848__$1,queries,properties))
,refs),raw_QMARK_);
});})(map__1848,map__1848__$1,queries,properties))
...
var vec__1858 = o;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1858,(0),null);
var test = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1858,(1),null);
var if$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1858,(2),null);
var else$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1858,(3),null);
...
var vec__1861 = data;
var form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1861,(0),null);
var bindings = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1861,(1),null);
...
pluto.reader.events.merge_pair = (function pluto$reader$events$merge_pair(m,p__1864){
var vec__1865 = p__1864;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1865,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1865,(1),null);
 ...
 */
pluto.reader.events.parse = (function pluto$reader$events$parse(ctx,ext,p__1868,arguments$){
var vec__1869 = p__1868;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1869,(0),null);
var let_bindings = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1869,(1),null);
var local = vec__1869;
...
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$event,(function (ctx,ext,_,p__1872){
var vec__1873 = p__1872;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1873,(0),null);
var arguments$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1873,(1),null);
var value = vec__1873;
var map__1876 = pluto.reader.reference.resolve(ctx,ext,cljs.core.cst$kw$event,value);
