...
var hierarchy__4617__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$hierarchy,(function (){var fexpr__2758 = cljs.core.get_global_hierarchy;
return (fexpr__2758.cljs$core$IFn$_invoke$arity$0 ? fexpr__2758.cljs$core$IFn$_invoke$arity$0() : fexpr__2758.call(null));
})());
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(pluto.error.merge_results_with,(function (p1__2759_SHARP_,p2__2760_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(p1__2759_SHARP_),p2__2760_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__2761_SHARP_){
var G__2762 = ctx;
var G__2763 = ext;
var G__2764 = cljs.core.first(type);
var G__2765 = p1__2761_SHARP_;
return (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(G__2762,G__2763,G__2764,G__2765) : pluto.reader.types.resolve.call(null,G__2762,G__2763,G__2764,G__2765));
}),value));
} else {
...
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$one_DASH_of,(function (_,___$1,p__2766,value){
...
var one_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2767__$1,cljs.core.cst$kw$one_DASH_of);
...
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$or,(function (ctx,ext,p__2770,value){
...
var or = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2771__$1,cljs.core.cst$kw$or);
if(cljs.core.coll_QMARK_(or)){
var temp__5455__auto__ = cljs.core.some(((function (map__2771,map__2771__$1,or){
return (function (p1__2769_SHARP_){
var temp__5457__auto__ = (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(ctx,ext,p1__2769_SHARP_,value) : pluto.reader.types.resolve.call(null,ctx,ext,p1__2769_SHARP_,value));
if(cljs.core.truth_(temp__5457__auto__)){
var map__2773 = temp__5457__auto__;
var map__2773__$1 = (((((!((map__2773 == null))))?(((((map__2773.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2773.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__2773):map__2773);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2773__$1,cljs.core.cst$kw$data);
return data;
} else {
return null;
}
});})(map__2771,map__2771__$1,or))
,or);
if(cljs.core.truth_(temp__5455__auto__)){
var o = temp__5455__auto__;
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,o], null);
...
pluto.reader.types.resolve_property = (function pluto$reader$types$resolve_property(ctx,ext,m,p__2776,type){
var map__2777 = p__2776;
var map__2777__$1 = (((((!((map__2777 == null))))?(((((map__2777.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2777.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__2777):map__2777);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2777__$1,cljs.core.cst$kw$name);
var optional_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2777__$1,cljs.core.cst$kw$optional_QMARK_);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2777__$1,cljs.core.cst$kw$value);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(pluto.reader.types.sentinel,value)){
var map__2779 = (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(ctx,ext,type,value) : pluto.reader.types.resolve.call(null,ctx,ext,type,value));
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2779__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2779__$1,cljs.core.cst$kw$errors);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(m,cljs.core.cst$kw$data,((function (map__2777,map__2777__$1,name,optional_QMARK_,value){
return (function (p1__2775_SHARP_){
if(cljs.core.empty_QMARK_(p1__2775_SHARP_)){
return cljs.core.PersistentArrayMap.EMPTY;
} else {
return p1__2775_SHARP_;
}
});})(map__2777,map__2777__$1,name,optional_QMARK_,value))
);
} else {
...
if(cljs.core.map_QMARK_(type)){
return cljs.core.reduce_kv((function (p1__2781_SHARP_,p2__2782_SHARP_,p3__2783_SHARP_){
return pluto.reader.types.resolve_property(ctx,ext,p1__2781_SHARP_,pluto.reader.types.property(p2__2782_SHARP_,value),p3__2783_SHARP_);
}),cljs.core.PersistentArrayMap.EMPTY,type);
} else {
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$errors,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.error.syntax.cljs$core$IFn$_invoke$arity$3(cljs.core.cst$kw$pluto$error_SLASH_invalid,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$type,cljs.core.cst$kw$type], null),new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$type,type,cljs.core.cst$kw$data,value,cljs.core.cst$kw$reason,cljs.core.cst$kw$assoc_DASH_type], null))], null)], null);
}
}));
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$query,(function (p__2784,ext,type,p__2785){
var map__2786 = p__2784;
...
var ctx = map__2786__$1;
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2786__$1,cljs.core.cst$kw$env);
var vec__2787 = p__2785;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2787,(0),null);
var arguments$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2787,(1),null);
var value = vec__2787;
var map__2791 = pluto.reader.reference.resolve(ctx,ext,type,value);
var map__2791__$1 = (((((!((map__2791 == null))))?(((((map__2791.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2791.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__2791):map__2791);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2791__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2791__$1,cljs.core.cst$kw$errors);
