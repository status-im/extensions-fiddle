...
return pluto.error.merge_results.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m,(function (){var G__1318 = value;
var G__1319 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(s,idx);
return (pluto.reader.destructuring.destructure_assoc.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.destructuring.destructure_assoc.cljs$core$IFn$_invoke$arity$2(G__1318,G__1319) : pluto.reader.destructuring.destructure_assoc.call(null,G__1318,G__1319));
})()], 0));
} else {
if(cljs.core.sequential_QMARK_(value)){
return pluto.error.merge_results.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m,(function (){var G__1320 = value;
var G__1321 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(s,idx);
return (pluto.reader.destructuring.destructure_seq.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.destructuring.destructure_seq.cljs$core$IFn$_invoke$arity$2(G__1320,G__1321) : pluto.reader.destructuring.destructure_seq.call(null,G__1320,G__1321));
})()], 0));
} else {
return null;
}
...
return cljs.core.reduce_kv((function (p1__1322_SHARP_,p2__1323_SHARP_,p3__1324_SHARP_){
return pluto.reader.destructuring.merge_seq_bindings(bindings,s,p1__1322_SHARP_,p2__1323_SHARP_,p3__1324_SHARP_);
...
return cljs.core.assoc_in(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$data,k], null),(function (){var or__4131__auto__ = (function (){var fexpr__1326 = cljs.core.first(v);
return (fexpr__1326.cljs$core$IFn$_invoke$arity$1 ? fexpr__1326.cljs$core$IFn$_invoke$arity$1(s) : fexpr__1326.call(null,s));
})();
...
return pluto.error.merge_results.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m,(function (){var G__1327 = k;
var G__1328 = (v.cljs$core$IFn$_invoke$arity$1 ? v.cljs$core$IFn$_invoke$arity$1(s) : v.call(null,s));
return (pluto.reader.destructuring.destructure_assoc.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.destructuring.destructure_assoc.cljs$core$IFn$_invoke$arity$2(G__1327,G__1328) : pluto.reader.destructuring.destructure_assoc.call(null,G__1327,G__1328));
})()], 0));
} else {
...
return cljs.core.reduce_kv((function (p1__1329_SHARP_,p2__1330_SHARP_,p3__1331_SHARP_){
return pluto.reader.destructuring.merge_assoc_bindings(s,p1__1329_SHARP_,p2__1330_SHARP_,p3__1331_SHARP_);
