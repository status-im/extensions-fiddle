...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__1524_SHARP_){
return ["0x",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__1526 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$type,react_native_web.ethereum.logs.types_mapping(type),cljs.core.cst$kw$value,p1__1524_SHARP_], null);
return (status_im.abi_spec.enc.cljs$core$IFn$_invoke$arity$1 ? status_im.abi_spec.enc.cljs$core$IFn$_invoke$arity$1(G__1526) : status_im.abi_spec.enc.call(null,G__1526));
})())].join('');
}),values);
});
...
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1527__$1,cljs.core.cst$kw$event);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1527__$1,cljs.core.cst$kw$params);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1527__$1,cljs.core.cst$kw$type);
...
var fexpr__1530 = cljs.core.zipmap(keys,X);
return (fexpr__1530.cljs$core$IFn$_invoke$arity$1 ? fexpr__1530.cljs$core$IFn$_invoke$arity$1(p1__1529_SHARP_) : fexpr__1530.call(null,p1__1529_SHARP_));
});})(keys))
,indexed);
});
/**
...
var indexes = (function (){var G__1531 = cljs.core.cst$kw$indexed;
return (hint.cljs$core$IFn$_invoke$arity$1 ? hint.cljs$core$IFn$_invoke$arity$1(G__1531) : hint.call(null,G__1531));
})();
var params = react_native_web.ethereum.logs.get_no_indexed((function (){var G__1532 = cljs.core.cst$kw$params;
return (hint.cljs$core$IFn$_invoke$arity$1 ? hint.cljs$core$IFn$_invoke$arity$1(G__1532) : hint.call(null,G__1532));
})(),indexes);
var names = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,react_native_web.ethereum.logs.get_no_indexed((function (){var G__1533 = cljs.core.cst$kw$names;
return (hint.cljs$core$IFn$_invoke$arity$1 ? hint.cljs$core$IFn$_invoke$arity$1(G__1533) : hint.call(null,G__1533));
})(),indexes));
...
return cljs.core.zipmap(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$topic1,cljs.core.cst$kw$topic2,cljs.core.cst$kw$topic3], null),cljs.core.mapv.cljs$core$IFn$_invoke$arity$3(status_im.abi_spec.hex_to_value,topics,react_native_web.ethereum.logs.get_indexed((function (){var G__1534 = cljs.core.cst$kw$params;
return (hint.cljs$core$IFn$_invoke$arity$1 ? hint.cljs$core$IFn$_invoke$arity$1(G__1534) : hint.call(null,G__1534));
})(),(function (){var G__1535 = cljs.core.cst$kw$indexed;
return (hint.cljs$core$IFn$_invoke$arity$1 ? hint.cljs$core$IFn$_invoke$arity$1(G__1535) : hint.call(null,G__1535));
})())));
});
/**
...
return react_native_web.ethereum.logs.event_topic_enc((function (){var G__1537 = cljs.core.cst$kw$event;
return (p1__1536_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__1536_SHARP_.cljs$core$IFn$_invoke$arity$1(G__1537) : p1__1536_SHARP_.call(null,G__1537));
})(),(function (){var G__1538 = cljs.core.cst$kw$params;
return (p1__1536_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__1536_SHARP_.cljs$core$IFn$_invoke$arity$1(G__1538) : p1__1536_SHARP_.call(null,G__1538));
})());
});})($))
,$);
...
react_native_web.ethereum.logs.parse_log = (function react_native_web$ethereum$logs$parse_log(events_hints,p__1540){
var map__1541 = p__1540;
...
var address = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1541__$1,cljs.core.cst$kw$address);
var transactionHash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1541__$1,cljs.core.cst$kw$transactionHash);
var blockHash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1541__$1,cljs.core.cst$kw$blockHash);
var transactionIndex = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1541__$1,cljs.core.cst$kw$transactionIndex);
var topics = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1541__$1,cljs.core.cst$kw$topics);
var blockNumber = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1541__$1,cljs.core.cst$kw$blockNumber);
var logIndex = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1541__$1,cljs.core.cst$kw$logIndex);
var removed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1541__$1,cljs.core.cst$kw$removed);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1541__$1,cljs.core.cst$kw$data);
...
})())?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$topics,react_native_web.ethereum.logs.decode_topics(cljs.core.filterv(((function (map__1541,map__1541__$1,address,transactionHash,blockHash,transactionIndex,topics,blockNumber,logIndex,removed,data){
return (function (p1__1539_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(topics),p1__1539_SHARP_)));
});})(map__1541,map__1541__$1,address,transactionHash,blockHash,transactionIndex,topics,blockNumber,logIndex,removed,data))
...
react_native_web.ethereum.logs.execute_get_logs = (function react_native_web$ethereum$logs$execute_get_logs(p__1544,ethereum_addr){
var map__1545 = p__1544;
...
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1545__$1,cljs.core.cst$kw$from);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1545__$1,cljs.core.cst$kw$to);
var address = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1545__$1,cljs.core.cst$kw$address);
var topics = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1545__$1,cljs.core.cst$kw$topics);
var block_hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1545__$1,cljs.core.cst$kw$block_DASH_hash);
var on_success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1545__$1,cljs.core.cst$kw$on_DASH_success);
var on_failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1545__$1,cljs.core.cst$kw$on_DASH_failure);
...
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$extensions_SLASH_send_DASH_async,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [react_native_web.ethereum.rpc_args("eth_getLogs",params,ethereum_addr),((function (params,map__1545,map__1545__$1,from,to,address,topics,block_hash,on_success,on_failure){
return (function (error,result){
return react_native_web.ethereum.rpc_dispatch(error,result,((function (params,map__1545,map__1545__$1,from,to,address,topics,block_hash,on_success,on_failure){
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (results,params,map__1545,map__1545__$1,from,to,address,topics,block_hash,on_success,on_failure){
return (function (p1__1543_SHARP_){
return react_native_web.ethereum.logs.parse_log(react_native_web.ethereum.logs.flatten_input(topics),p1__1543_SHARP_);
});})(results,params,map__1545,map__1545__$1,from,to,address,topics,block_hash,on_success,on_failure))
,results);
});})(params,map__1545,map__1545__$1,from,to,address,topics,block_hash,on_success,on_failure))
,on_success,on_failure);
});})(params,map__1545,map__1545__$1,from,to,address,topics,block_hash,on_success,on_failure))
], null)], null);
});
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$extensions_SLASH_ethereum_DASH_logs,(function (p__1547,p__1548){
var map__1549 = p__1547;
...
var map__1550 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1549__$1,cljs.core.cst$kw$db);
...
var ethereum_addr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1550__$1,cljs.core.cst$kw$ethereum_DASH_addr);
var vec__1551 = p__1548;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1551,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1551,(1),null);
var arguments$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1551,(2),null);
