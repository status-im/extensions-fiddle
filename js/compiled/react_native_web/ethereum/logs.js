...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__1493_SHARP_){
return ["0x",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__1495 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$type,react_native_web.ethereum.logs.types_mapping(type),cljs.core.cst$kw$value,p1__1493_SHARP_], null);
return (status_im.abi_spec.enc.cljs$core$IFn$_invoke$arity$1 ? status_im.abi_spec.enc.cljs$core$IFn$_invoke$arity$1(G__1495) : status_im.abi_spec.enc.call(null,G__1495));
})())].join('');
}),values);
});
...
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1496__$1,cljs.core.cst$kw$event);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1496__$1,cljs.core.cst$kw$params);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1496__$1,cljs.core.cst$kw$type);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1496__$1,cljs.core.cst$kw$values);
if((!((event == null)))){
...
return (function (p1__1498_SHARP_){
var fexpr__1499 = cljs.core.zipmap(keys,X);
return (fexpr__1499.cljs$core$IFn$_invoke$arity$1 ? fexpr__1499.cljs$core$IFn$_invoke$arity$1(p1__1498_SHARP_) : fexpr__1499.call(null,p1__1498_SHARP_));
});})(keys))
,indexed);
});
/**
...
var indexes = (function (){var G__1500 = cljs.core.cst$kw$indexed;
return (hint.cljs$core$IFn$_invoke$arity$1 ? hint.cljs$core$IFn$_invoke$arity$1(G__1500) : hint.call(null,G__1500));
})();
var params = react_native_web.ethereum.logs.get_no_indexed((function (){var G__1501 = cljs.core.cst$kw$params;
return (hint.cljs$core$IFn$_invoke$arity$1 ? hint.cljs$core$IFn$_invoke$arity$1(G__1501) : hint.call(null,G__1501));
})(),indexes);
var names = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,react_native_web.ethereum.logs.get_no_indexed((function (){var G__1502 = cljs.core.cst$kw$names;
return (hint.cljs$core$IFn$_invoke$arity$1 ? hint.cljs$core$IFn$_invoke$arity$1(G__1502) : hint.call(null,G__1502));
})(),indexes));
...
return cljs.core.zipmap(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$topic1,cljs.core.cst$kw$topic2,cljs.core.cst$kw$topic3], null),cljs.core.mapv.cljs$core$IFn$_invoke$arity$3(status_im.abi_spec.hex_to_value,topics,react_native_web.ethereum.logs.get_indexed((function (){var G__1503 = cljs.core.cst$kw$params;
return (hint.cljs$core$IFn$_invoke$arity$1 ? hint.cljs$core$IFn$_invoke$arity$1(G__1503) : hint.call(null,G__1503));
})(),(function (){var G__1504 = cljs.core.cst$kw$indexed;
return (hint.cljs$core$IFn$_invoke$arity$1 ? hint.cljs$core$IFn$_invoke$arity$1(G__1504) : hint.call(null,G__1504));
})())));
});
/**
...
return (function (p1__1505_SHARP_){
return react_native_web.ethereum.logs.event_topic_enc((function (){var G__1506 = cljs.core.cst$kw$event;
return (p1__1505_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__1505_SHARP_.cljs$core$IFn$_invoke$arity$1(G__1506) : p1__1505_SHARP_.call(null,G__1506));
})(),(function (){var G__1507 = cljs.core.cst$kw$params;
return (p1__1505_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__1505_SHARP_.cljs$core$IFn$_invoke$arity$1(G__1507) : p1__1505_SHARP_.call(null,G__1507));
})());
});})($))
,$);
...
react_native_web.ethereum.logs.parse_log = (function react_native_web$ethereum$logs$parse_log(events_hints,p__1509){
...
var logIndex = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1510__$1,cljs.core.cst$kw$logIndex);
var removed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1510__$1,cljs.core.cst$kw$removed);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1510__$1,cljs.core.cst$kw$data);
var address = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1510__$1,cljs.core.cst$kw$address);
var blockHash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1510__$1,cljs.core.cst$kw$blockHash);
var transactionHash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1510__$1,cljs.core.cst$kw$transactionHash);
var transactionIndex = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1510__$1,cljs.core.cst$kw$transactionIndex);
var topics = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1510__$1,cljs.core.cst$kw$topics);
var blockNumber = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1510__$1,cljs.core.cst$kw$blockNumber);
...
})())?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$topics,react_native_web.ethereum.logs.decode_topics(cljs.core.filterv(((function (map__1510,map__1510__$1,logIndex,removed,data,address,blockHash,transactionHash,transactionIndex,topics,blockNumber){
return (function (p1__1508_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(topics),p1__1508_SHARP_)));
});})(map__1510,map__1510__$1,logIndex,removed,data,address,blockHash,transactionHash,transactionIndex,topics,blockNumber))
...
react_native_web.ethereum.logs.execute_get_logs = (function react_native_web$ethereum$logs$execute_get_logs(p__1513,ethereum_addr){
var map__1514 = p__1513;
...
var from = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1514__$1,cljs.core.cst$kw$from);
var to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1514__$1,cljs.core.cst$kw$to);
var address = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1514__$1,cljs.core.cst$kw$address);
var topics = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1514__$1,cljs.core.cst$kw$topics);
var block_hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1514__$1,cljs.core.cst$kw$block_DASH_hash);
var on_success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1514__$1,cljs.core.cst$kw$on_DASH_success);
var on_failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1514__$1,cljs.core.cst$kw$on_DASH_failure);
...
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$extensions_SLASH_send_DASH_async,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [react_native_web.ethereum.rpc_args("eth_getLogs",params,ethereum_addr),((function (params,map__1514,map__1514__$1,from,to,address,topics,block_hash,on_success,on_failure){
return (function (error,result){
return react_native_web.ethereum.rpc_dispatch(error,result,((function (params,map__1514,map__1514__$1,from,to,address,topics,block_hash,on_success,on_failure){
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (results,params,map__1514,map__1514__$1,from,to,address,topics,block_hash,on_success,on_failure){
return (function (p1__1512_SHARP_){
return react_native_web.ethereum.logs.parse_log(react_native_web.ethereum.logs.flatten_input(topics),p1__1512_SHARP_);
});})(results,params,map__1514,map__1514__$1,from,to,address,topics,block_hash,on_success,on_failure))
,results);
});})(params,map__1514,map__1514__$1,from,to,address,topics,block_hash,on_success,on_failure))
,on_success,on_failure);
});})(params,map__1514,map__1514__$1,from,to,address,topics,block_hash,on_success,on_failure))
], null)], null);
});
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$extensions_SLASH_ethereum_DASH_logs,(function (p__1516,p__1517){
var map__1518 = p__1516;
...
var map__1519 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1518__$1,cljs.core.cst$kw$db);
...
var ethereum_addr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1519__$1,cljs.core.cst$kw$ethereum_DASH_addr);
var vec__1520 = p__1517;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1520,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1520,(1),null);
var arguments$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1520,(2),null);
